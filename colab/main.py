...
def main(_):
    ...
    if useOntology == True:
        ...
        # NOTE: I thin there is a mistake in comments, I think the version that is not commented out is the out-of-sample and not in-smaple
        # In-sample accuracy
        ...
        # NOTE: a way to buypass ontology part, all the values are provided so we do not need to run it
        if shortCutOnt == True:
            #2015
            #accuracyOnt = 0.8277
            #remaining_size = 301
...
# NOTE: this is never used, can we delete it ?
'''
    # LCR-Rot model
    #if runLCRROT == True:
